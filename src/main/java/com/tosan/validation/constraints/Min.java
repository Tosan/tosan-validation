...
import com.tosan.validation.constraints.impl.MinValidator;
...
/**
 * Custom Min validation which can use key-value for validation instead using a constant value.
 * can not use both keyValue and value as parameters in the Min annotation or both keyValue and value can not be null
...
public @interface Min {
    String message() default "The value must be bigger than {keyValue}{value}";
